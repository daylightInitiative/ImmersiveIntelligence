 ...
 * @since 20.02.2023
 *
 * Modified Specifically for the Shotgun
 */
public abstract class ModifiedAmmoHandlerList extends AmmoHandler
{
	private final IAmmoTypeItem validAmmo;
	private final String tag;
	private int size;

	public ModifiedAmmoHandlerList(ItemIIGunBase item, String tag, IAmmoTypeItem validAmmo, int size)
	{
		super(item);
		this.tag = tag;
